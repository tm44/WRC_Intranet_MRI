...
{
    public class Block16PositivePayFormatter : BasePositivePayFormatter
    {
        public override string BankID => "130113";

        public override string FileName => "JPM" + DateTime.Now.ToString("MMddyy") + "_130113.txt";

        public override string AccountNumber => "691349200";

        public Block16PositivePayFormatter(StreamWriter writer) : base(writer)
        {
        }
